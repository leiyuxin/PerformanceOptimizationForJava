...
public class GatherBufferTest {
	private static final String TPATH = "e:/gather.txt"; // 文件路径
	static int booklen = 0;
	static int authlen = 0;

	@Test
	public void testGatherData() throws Exception {
		ByteBuffer bookBuf = ByteBuffer.wrap("java性能优化".getBytes("utf-8"));
		ByteBuffer autBuf = ByteBuffer.wrap("雷雨鑫".getBytes("utf-8"));
