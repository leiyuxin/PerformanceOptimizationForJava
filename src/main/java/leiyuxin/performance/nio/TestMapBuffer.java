...
public class TestMapBuffer {
	...
	public void testStreamWrite() throws IOException {
		...
		DataOutputStream dos = new DataOutputStream(
				new BufferedOutputStream(new FileOutputStream(new File("e:\\temp_stream.tmp"))));
	...
	public void testStreamRead() throws IOException {
		...
		DataInputStream dis = new DataInputStream(
				new BufferedInputStream(new FileInputStream(new File("e:\\temp_stream.tmp"))));
		for (int i = 0; i < numOfInts; i++) {
			dis.readInt();
		}
		if (dis != null) {
	...
	public void testMappedWrite() throws IOException {
		long starttime = System.currentTimeMillis();
		FileChannel fc = new RandomAccessFile("e:\\temp_mapped.tmp", "rw").getChannel();
	...
	public void testMappedRead() throws IOException {
		long starttime = System.currentTimeMillis();
		FileChannel fc = new FileInputStream("e:\\temp_mapped.tmp").getChannel();
