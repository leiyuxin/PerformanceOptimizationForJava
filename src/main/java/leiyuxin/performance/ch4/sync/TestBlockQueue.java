package leiyuxin.performance.ch4.sync;
	...
	public static class PutThread extends Thread {
		...
		public void run() {
			...
			while (true) {
				...
				queue.put(obj);
				System.out.println(System.currentTimeMillis() + ":" + Thread.currentThread().getName() + " PUT OBJECT");
				try {
		...
		public void run() {
			...
			while (true) {
				try {
					...
					if (obj != null)
						System.out.println(
								System.currentTimeMillis() + ":" + Thread.currentThread().getName() + " Get Object");
					else
						System.out.println(
								System.currentTimeMillis() + ":" + Thread.currentThread().getName() + " Get NULL");
