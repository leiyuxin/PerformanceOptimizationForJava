package leiyuxin.performance.ch4.threadpool;
...
public class TestCustomThreadPool {
	...
	public void testThreadPoolExecutor1() throws InterruptedException {
		...
		// ExecutorService exe=new MyThreadPoolExecutor(100,600,0L,TimeUnit.SECONDS,new
		// ArrayBlockingQueue<Runnable>(200));
		ExecutorService exe = new MyThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS,
