...
import leiyuxin.performance.ch5.memory.JavaBeanObject;
import leiyuxin.performance.ch5.memory.MyClassLoader;
import leiyuxin.performance.ch5.memory.MyMethodInterceptor;
...
public class TraceClassInstance {
	...
	private static JavaBeanObject createInstance2(int i) throws CannotCompileException,
		...
		c.setSuperclass(ClassPool.getDefault().get("leiyuxin.performance.ch5.memory.JavaBeanObject"));
